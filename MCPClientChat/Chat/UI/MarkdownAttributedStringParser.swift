...
// COMMENTED OUT - This was the full markdown parser that requires Swift Markdown framework
// Using SimpleMarkdownParser instead for basic code block support
...
/// Simplified markdown parser without Swift Markdown dependency
...
public struct MarkdownAttributedStringParser {
    ...
    mutating public func visitInlineCode(_ inlineCode: InlineCode) -> NSAttributedString {
        NSAttributedString(string: inlineCode.code, attributes: [.font: NSFont.monospacedSystemFont(ofSize: baseFontSize - 1.0, weight: .regular), .foregroundColor: NSColor(.primary)])
    }
    
    public func visitCodeBlock(_ codeBlock: CodeBlock) -> NSAttributedString {
        // Simple code block formatting without Splash syntax highlighting
